...
void ssd1306_init(SSD1306_t * dev, int width, int height); //dùng
...
void ssd1306_display_image(SSD1306_t * dev, int page, int seg, uint8_t * images, int width); //dùng
void ssd1306_display_text(SSD1306_t * dev, int page, char * text, int text_len, bool invert); //dùng
...
void ssd1306_display_text_x3(SSD1306_t * dev, int page, char * text, int text_len, bool invert); //dùng
void ssd1306_clear_screen(SSD1306_t * dev, bool invert); //dùng
//void ssd1306_clear_line(SSD1306_t * dev, int page, bool invert);
void ssd1306_contrast(SSD1306_t * dev, int contrast); //dùng
...
void ssd1306_invert(uint8_t *buf, size_t blen); //dùng
void ssd1306_flip(uint8_t *buf, size_t blen); //dùng
// uint8_t ssd1306_copy_bit(uint8_t src, int srcBits, uint8_t dst, int dstBits);
uint8_t ssd1306_rotate_byte(uint8_t ch1); //dùng
...
void spi_master_init(SSD1306_t * dev, int16_t mosi, int16_t sclk, int16_t cs, int16_t dc, int16_t reset); //dùng
//void spi_device_add(SSD1306_t * dev, int16_t cs, int16_t dc, int16_t reset); 
bool spi_master_write_byte(spi_device_handle_t SPIHandle, const uint8_t* Data, size_t DataLength ); //dùng
bool spi_master_write_command(SSD1306_t * dev, uint8_t Command ); //dùng
bool spi_master_write_data(SSD1306_t * dev, const uint8_t* Data, size_t DataLength );//dùng
void spi_init(SSD1306_t * dev, int width, int height); //dùng
void spi_display_image(SSD1306_t * dev, int page, int seg, uint8_t * images, int width); //dùng
void spi_contrast(SSD1306_t * dev, int contrast); //dùng
